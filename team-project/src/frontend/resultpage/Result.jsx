...
function Result(props) {
    ...
    const explanation = [
        '사려도 깊고 남을 챙겨주기 좋아하는 당신! 리더의 기질을 가지고 있어서 믿음직스럽기도 하고, 순수한 영혼을 가지고 있어서 사람들과 어울리는데 어려움이 없어 보여요!',
        ...
        '내가 짱이다라는 생각을 해본 적이 있나요? 당신은 리더의 기질이 강해서 차가워 보인다는 소리를 들어본 적이 있을 것이에요! 하지만 숨어있는 따듯함을 지닌 사람이네요!',
        '쾌활하고 자유로운 영혼을 가진 당신! 개방적이긴 하지만 직설적이고 거침없게 말해서 카리스마가 있다는 소리를 들어본 적이 있을 것 같아요! 지적 호기심도 많고 어려운 문제를 즐겨서인지 아이디어가 넘쳐나는 사람이네요!',
        ...
        '겉으로 보기엔 차가운 당신! 하지만 숨어있는 따듯함으로 주변 사람들을 감동시키곤 해요. 사람들과 같이 하는 것보다는 혼자 부지런히 지적 호기심을 충족시키곤 하죠! 텐션이 높은 편은 아니지만 리더의 역할을 해야 할 때 칼같이 잘 해내요!',
        ...
        '집에서 잘 안 나오고 싶어 하는 당신! 그럼에도 한번 집에서 나오면 부드럽고 유연한 성격 때문인지 사람들과 잘 융화되는 모습이 보여요! 표현 방법이 적극적이진 않지만 리액션을 참 잘해줘요!',
        '효율을 중요시하는 당신! 주변을 객관적으로 분석하고 사실에 입각하여 현실적으로 실행 가능한 계획을 세우는 것을 선호하는 것 같아요! 겉으로 튀는 것을 별로 좋아하지 않아서 \n차가운 인상을 주곤 해요.',
        '필요에 따라 사교적인 당신! 타인의 일에는 무관심한 편이라 관심분야가 아니면 쳐다보지도 않아요. 아마 생각은 적극적이지만 행동은 소극적일 수도 있는 사람이네요!',
    ];
    const imageList = [
        { ENFJ: ENFJ },
        { ENFP: ENFP },
